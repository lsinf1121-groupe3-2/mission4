...
De plus, deux nouvelles classes \verb+BinaryTreeSearch+ et \verb+Search+ permettent de stocker et d'aller rechercher les journaux pour les différents types de champs.
\newpage
